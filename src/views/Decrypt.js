...
class Decrypt extends Component {
  ...
  render() {
    ...
    let showText = null;
    if (textEncrypted !== '') {
      showText = <Alert class="alert alert-success" text={textEncrypted} mode="decrypted"></Alert>
    }else if (this.state.loading) {
      showText = <Alert class="alert alert-warning" text="loading" mode="decrypted"></Alert>
    }
    else{
      showText = <br></br>;
    }
    return (
      <form onSubmit={this.handleSubmit} >
        ...
        <div className="form-group row">
          <label>Write the text you want to decrypt</label>
